...
data <- read_excel("./tfmp_deployment_metadata_base_copy.xlsx", sheet = "deployment summary")
...
write_xlsx(summary, "./tfmp_deployment_summary_autogenerated.xlsx")
write_xlsx(final, "./tfmp_deployment_metadata_autogenerated.xlsx")
